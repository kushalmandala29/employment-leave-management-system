...
class Role(models.Model):
    ...
    name = models.CharField(max_length=125,choices=ROLE_CHOICES)
...
class Department(models.Model):
    ...
    name = models.CharField(max_length=125,choices=DEPARTMENT_CHOICES)
    description = models.CharField(max_length=125,null=True,blank=True)
...
class Employee(models.Model):
    ...
    department =  models.ForeignKey(Department,verbose_name =_('Department'),on_delete=models.SET_NULL,null=True,default=None,choices=DEPARTMENT_CHOICES)
    role =  models.ForeignKey(Role,verbose_name =_('Role'),on_delete=models.SET_NULL,null=True,default=None,choices=ROLE_CHOICES)
